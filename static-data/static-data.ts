...
export const SETTINGS_DATA: SettingsData[] = [
  ...
  },
  {
    ...
    data: [
      {
        elementTitle: "Practice Reminder",
        ImgComponentLight: PracticeLightIcon,
        ImgComponentDark: PracticeDarkIcon,
        actionType: "switcher",
  ...
  },
  {
    ...
    data: [
      ...
      {
        elementTitle: "Acknowledgment",
        ImgComponentLight: AcknowledgementLightIcon,
        ImgComponentDark: AcknowledgementDarkIcon,
        actionType: "router",
